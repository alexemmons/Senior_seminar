...
\todo[inline]{explain bins and terms that are used later. Explain types and how they work and give more info. Explain more about overtones and how they are detected, give more examples of 'other tones'. Add a figure.}
...
\todo[inline]{Describe them or some of them. Decide between using pitch class and chroma.}
...
\todo[inline]{Need to re-write this section from draft. Maybe move this to background, find first instance of HMM.}
...
\todo[inline]{Re-write and add more, explain how bins are combined to pcp.}
