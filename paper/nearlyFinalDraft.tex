...
\todo[inline]{Try to describe this better.}

%\subsubsection{Support Vector Models}
%
%\todo[inline]{Todo, or just explain what program they used in case 1 section.}
...
%\todo[inline]{Need to add: Genre-specific models. Apps that provide chords for any song.}
